...
type
  ...
  public
    ...
    procedure CarregaDbGrid(ASQLConnection: TFDConnection; SnQuery: Boolean; ISnSituacao: Integer; AIdServico: Integer; AConsulta: String; Data: TClientDataSet);
...
procedure TServico.CarregaDbGrid(ASQLConnection: TFDConnection; SnQuery: Boolean; ISnSituacao: Integer; AIdServico: Integer; AConsulta: String; Data: TClientDataSet);
var
  qryServico : TFDQuery;
  I            : Integer;
  lCampo       : TField;
