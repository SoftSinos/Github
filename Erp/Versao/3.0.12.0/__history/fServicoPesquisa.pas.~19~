...
begin
  ...
  try
    ...
    begin
      unServico.CarregaDbGrid(DtmPrincipal.Conexao, True, 2, 0, EdtPesquisa.Text, dnRelatorios.CDSRelPesquisa);
    end
    else
    begin
      unServico.CarregaDbGrid(DtmPrincipal.Conexao, True, 2, DtmPrincipal.IdEmpresaLogada, EdtPesquisa.Text, dnRelatorios.CDSRelPesquisa);
    end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        unServico.CarregaDbGrid(DtmPrincipal.Conexao, True, 2, 0, EdtPesquisa.Text, CdsPesquisa);
      end;
    end;
  finally
    unServico.Free;
