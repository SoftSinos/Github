...
type
  ...
  public
    ...
    property NmProcedure        : String    read FNmProcedure         write FNmProcedure;
    ...
    function BuscarNomeRelatorio(ASQLConnection: TFDConnection; ANmRelatorio: String): Boolean;
...
begin
  ...
  try
    ...
    begin
      ...
      Data.FieldDefs.Add('NmTpRelatorio', ftString, 255, False);
      Data.FieldDefs.Add('NmArquivoRelatorio', ftString, 255, False);
      Data.FieldDefs.Add('NmRelatorio', ftString, 255, False);
      Data.FieldDefs.Add('NmProcedure', ftString, 255, False);
      Data.CreateDataSet;
    end;
    ...
    begin
      ...
      qryRelatorio.SQL.Add('  NmProcedure           ');
      ...
      begin
        ...
        begin
          ...
          Data.FieldByName('NmProcedure').AsString        := qryRelatorio.FieldByName('NmProcedure').AsString;
          Data.Post;
        end;
...
begin
  ...
  try
    ...
    begin
      ...
      qryRelatorio.SQL.Add('  NmProcedure = :NmProcedure                ');
    ...
    qryRelatorio.ParamByName('NmProcedure       ').AsString   := NmProcedure;
   try
...
begin
  ...
  try
    ...
    begin
      ...
      NmProcedure         := qryRelatorio.FieldByName('NmProcedure').AsString;
    end;
    qryRelatorio.Close;
  finally
    FreeAndNil(qryRelatorio)
...
function TRelatorio.BuscarNomeRelatorio(ASQLConnection: TFDConnection; ANmRelatorio: String): Boolean;
var
  qryRelatorio: TFDQuery;
begin
  Result := False;
  ...
  try
    ...
    qryRelatorio.SQL.Add('Select * From Relatorio         ');
    qryRelatorio.SQL.Add('Where 1 = 1                     ');
    qryRelatorio.SQL.Add('  And NmRelatorio = :NmRelatorio');

    qryRelatorio.ParamByName('NmRelatorio').AsString := ANmRelatorio;
