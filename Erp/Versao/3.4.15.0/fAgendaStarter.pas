...
uses
  ...
  cxTextEdit, cxMaskEdit, cxDropDownEdit, cxCalendar, Vcl.Buttons, Vcl.ExtCtrls, cxSpinEdit, cxTimeEdit, Vcl.Grids, Vcl.DBGrids, Vcl.Menus, cxButtons, cxCheckBox;
...
begin
  ...
  try
    ...
    begin
      ...
      CldMeses.MinDate         := CldMeses.Date;
    end;
