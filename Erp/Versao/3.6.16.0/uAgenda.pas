...
type
  ...
  public
    ...
    property NrAgenda               : String    read FNrAgenda              write FNrAgenda;
    ...
    function BuscarNrAgenda(ASQLConnection: TFDConnection; ANrAgenda: String): Boolean;
    class function BuscaMaxId(ASQLConnection: TFDConnection): Integer;
    procedure CarregaDbGrid(ASQLConnection: TFDConnection; ISnSituacao: Integer; AIdAgenda: Integer; AIdEmpProfissional: Integer; AIdProfissional: Integer; ADtAgenda: TDate; ATpChamadaClasse: String; AConsulta: String; Data: TClientDataSet);
    procedure CarregaDbGridHorarios(ASQLConnection: TFDConnection; AIdEmpresa: Integer; ADtAgenda: TDate; Data: TClientDataSet);
    procedure CarregaDbGridProfissionais(ASQLConnection: TFDConnection; AIdEmpresa: Integer; ADtAgenda: TDate; AOrdem: String; Data: TClientDataSet);
...
procedure TAgenda.CarregaDbGrid(ASQLConnection: TFDConnection; ISnSituacao: Integer; AIdAgenda: Integer; AIdEmpProfissional: Integer; AIdProfissional: Integer; ADtAgenda: TDate; ATpChamadaClasse: String; AConsulta: String; Data: TClientDataSet);
var
  qryAgenda : TFDQuery;
  I            : Integer;
  lCampo       : TField;
...
begin
  ...
  try
    ...
    begin
      ...
      Data.FieldDefs.Add('NrAgenda', ftString, 10, False);
    ...
    begin
      ...
      if (ADtAgenda > 0) and (ATpChamadaClasse = '') then
      begin
      ...
      if (ADtAgenda > 0) and (ATpChamadaClasse = 'AgendaPesquisa') then
      begin
        qryAgenda.SQL.Add('  And DtAgenda >= :DtAgenda');
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            Data.FieldByName('SnRealizada').AsString          := 'NÃO REALIZADO';
          end;
          ...
          Data.FieldByName('NrAgenda').AsString               := qryAgenda.FieldByName('NrAgenda').AsString;
...
begin
  ...
  try
    ...
    begin
      qryAgenda.Params.Clear;
      qryAgenda.SQL.Clear;
      qryAgenda.SQL.Add('Select Distinct                                  ');
      qryAgenda.SQL.Add('  Top (dbo.FN_AtendimentoProfissionaisDia(:DtAgenda, ''Atendimento''))');
      qryAgenda.SQL.Add('  IdAgendaEncaixe,                               ');
      qryAgenda.SQL.Add('  Cast(HrAgenda As Varchar(5)) HrAgenda          ');
      qryAgenda.SQL.Add('From VW_GridAgenda                               ');
      qryAgenda.SQL.Add('Where 1 = 1                                      ');
      qryAgenda.SQL.Add('  And DtAgenda = :DtAgenda                       ');
...
procedure TAgenda.CarregaDbGridProfissionais(ASQLConnection: TFDConnection; AIdEmpresa: Integer; ADtAgenda: TDate; AOrdem: String; Data: TClientDataSet);
var
  qryAgenda : TFDQuery;
  I         : Integer;
begin
  ...
  try
    ...
    if Data.FieldCount = 0 then
    begin
      Data.FieldDefs.Add('IdEmpProfissional', ftString, 255, False);
      Data.FieldDefs.Add('IdProfissional', ftInteger);
      Data.FieldDefs.Add('NmProfissional', ftString, 255, False);
      Data.FieldDefs.Add('NmApelidoProfissional', ftString, 255, False);
      Data.CreateDataSet;
    ...
    begin
      ...
      begin
        Data.Append;
          Data.FieldByName('IdEmpProfissional').AsString      := 'EMPRESA: ' + qryAgenda.FieldByName('IdEmpProfissional').AsString;
...
begin
  ...
  try
    ...
    begin
      ...
      NrAgenda              := qryAgenda.FieldByName('NrAgenda').AsString;
...
function TAgenda.BuscarNrAgenda(ASQLConnection: TFDConnection; ANrAgenda: String): Boolean;
var
  qryAgenda: TFDQuery;
begin
  Result := False;
  ...
  try
    ...
    qryAgenda.SQL.Add('Select * From VW_GridAgenda    ');
    qryAgenda.SQL.Add('Where 1 = 1                    ');
    qryAgenda.SQL.Add('  And NrAgenda = ' + ANrAgenda );
