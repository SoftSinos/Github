...
begin
  ...
  try
    if FrmPrincipal.TasAgendaStarter = Nil then
    begin
      FrmPrincipal.TasAgendaStarter             := TTabSheet.Create(FrmPrincipal.PgcPrincipal);
      FrmPrincipal.TasAgendaStarter.Caption     := 'Agenda do Básica';
      FrmPrincipal.TasAgendaStarter.PageControl := FrmPrincipal.PgcPrincipal;
    end
    else
    begin
      FrmPrincipal.TasAgendaStarter.TabVisible  := True;
    end;

    FrmPrincipal.PgcPrincipal.Visible    := True;
    FrmPrincipal.PgcPrincipal.ActivePage := FrmPrincipal.TasAgendaStarter;
