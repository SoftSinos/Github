...
uses
  ...
  fAgendaPesquisa in 'fAgendaPesquisa.pas' {FrmAgendaPesquisa},
  fDespesas in 'fDespesas.pas' {FrmDespesas},
  fBaixaParcelas in 'fBaixaParcelas.pas' {FrmBaixaParcelas},
  fPessoaRapido in 'fPessoaRapido.pas' {FrmPessoaRapido},
  fOperacaoFinanceira in 'fOperacaoFinanceira.pas' {FrmOperacaoFinanceira},
  fFechamentoCaixa in 'fFechamentoCaixa.pas' {FrmFechamentoCaixa},
  uTipoMovimento in 'uTipoMovimento.pas',
  uCaixa in 'uCaixa.pas',
  uCaixaFechamento in 'uCaixaFechamento.pas',
  fBase in '..\..\Classes\Base\fBase.pas' {FrmBase},
  fAgendaPremium in 'fAgendaPremium.pas' {FrmAgendaPremium},
  uAgendaPremium in 'uAgendaPremium.pas';
