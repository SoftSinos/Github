...
type
  ...
  public
    ...
    procedure CarregaDbGrid(ASQLConnection: TFDConnection; ISnSituacao: Integer; AIdEmpresa: Integer; AIdPessoa: Integer; AConsulta: String; IIdTpPessoa: Integer; APesquisa: String; Data: TClientDataSet);
    procedure CarregaDbGridProfissionais(ASQLConnection: TFDConnection; AIdEmpresa: Integer; Data: TClientDataSet);

    function NumeroPessoaTipoPessoa(ASQLConnection: TFDConnection; AIdEmpresa: Integer; APesquisa: String): Integer;
...
procedure TPessoa.CarregaDbGrid(ASQLConnection: TFDConnection; ISnSituacao: Integer; AIdEmpresa: Integer; AIdPessoa: Integer; AConsulta: String; IIdTpPessoa: Integer; APesquisa: String; Data: TClientDataSet);
var
  qryPessoa : TFDQuery;
  I            : Integer;
  lCampo       : TField;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        qryPessoa.SQL.Add('  And IdEmpresa = :IdEmpresa');

        qryPessoa.ParamByName('IdEmpresa').AsInteger := AIdEmpresa
      end;
      ...
      if APesquisa =  'Funcionario' then
      begin
        qryPessoa.SQL.Add('  And SnFuncionario = 1');
      end;

      if APesquisa =  'Servico' then
      begin
        qryPessoa.SQL.Add('  And SnServico = 1');
      end;
...
procedure TPessoa.CarregaDbGridProfissionais(ASQLConnection: TFDConnection; AIdEmpresa: Integer; Data: TClientDataSet);
var
  qryAgenda : TFDQuery;
  I         : Integer;
begin
  ...
  try
    ...
    begin
      ...
      qryAgenda.SQL.Add('  Distinct IdPessoa As IdProfissional,           ');
      qryAgenda.SQL.Add('  IdEmpresa As IdEmpProfissional,                ');
      qryAgenda.SQL.Add('  NmPessoa As NmProfissional,                    ');
      qryAgenda.SQL.Add('  NmApelido As NmApelidoProfissional             ');
      qryAgenda.SQL.Add('From VW_GridPessoa                               ');
      qryAgenda.SQL.Add('Where 1 = 1                                      ');
      qryAgenda.SQL.Add('  And SnServico = 1                              ');
...
function TPessoa.NumeroPessoaTipoPessoa(ASQLConnection: TFDConnection; AIdEmpresa: Integer; APesquisa: String): Integer;
var
  qryPessoa: TFDQuery;
begin
  Result := 0;
  ...
  try
    qryPessoa.Connection := ASQLConnection;
    qryPessoa.SQL.Add('Select Count(*) NrTotal From VW_GridPessoa ');
    qryPessoa.SQL.Add('Where 1 = 1                                ');
    ...
    begin
      Result := qryPessoa.FieldByName('NrTotal').AsInteger;
    end;
    qryPessoa.Close;
  finally
