  ...
  begin
    ...
    begin
      try
        ...
        if CdsPesquisa.FieldByName('HxCor').AsString <> '' then
        begin
          FrmTipoServico.BtnMostrarCor.Colors.Disabled    := StringToColor(CdsPesquisa.FieldByName('HxCor').AsString);
          FrmTipoServico.BtnMostrarCor.Colors.DisabledText:= StringToColor(CdsPesquisa.FieldByName('HxCor').AsString);
        end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        unTipoServico.CarregaDbGrid(DtmPrincipal.Conexao, lSnSituacao, 0, EdtPesquisa.Text, CdsPesquisa);
      end;
    end;
  finally
    unTipoServico.Free;
