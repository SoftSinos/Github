...
type
  ...
  public
    ...
    property SnServico          : Integer   read FSnServico         write FSnServico;
    property SnComissao         : Integer   read FSnComissao        write FSnComissao;
...
begin
  ...
  try
    ...
    begin
      ...
      Data.FieldDefs.Add('SnServico',         ftString, 7,    False);
      Data.FieldDefs.Add('SnComissao',        ftString, 7,    False);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if qryTipoPessoa.FieldByName('SnServico').AsBoolean then
          begin
            Data.FieldByName('SnServico').AsString   := 'ATIVO';
          end else begin
            Data.FieldByName('SnServico').AsString   := 'INATIVO';
          end;
          if qryTipoPessoa.FieldByName('SnComissao').AsBoolean then
          begin
            Data.FieldByName('SnComissao').AsString   := 'ATIVO';
          end else begin
            Data.FieldByName('SnComissao').AsString   := 'INATIVO';
          end;
...
begin
  ...
  try
    ...
    begin
      ...
      qryTipoPessoa.SQL.Add('  SnServico,                     ');
      qryTipoPessoa.SQL.Add('  SnComissao)                    ');
      ...
      qryTipoPessoa.SQL.Add('  SnServico = :SnServico,        ');
      qryTipoPessoa.SQL.Add('  SnComissao = :SnComissao       ');
    ...
    qryTipoPessoa.ParamByName('SnServico').AsInteger     := SnServico;
    qryTipoPessoa.ParamByName('SnComissao').AsInteger    := SnComissao;
   try
