...
type
  TFrmTipoPessoa = class(TFrmCadastro)
    ...
    ChkSnServico: TcxCheckBox;
    ChkSnComissao: TcxCheckBox;
...
begin
  ...
  try
    ...
    begin
      ...
      if ChkSnServico.Checked then
      begin
        unTipoPessoa.SnServico := 1;
      end
      else
      begin
        unTipoPessoa.SnServico := 0;
      end;
      if ChkSnComissao.Checked then
      begin
        unTipoPessoa.SnComissao := 1;
      end
      else
      begin
        unTipoPessoa.SnComissao := 0;
      end;
...
begin
  ...
  try
    ...
    if CdsCopula.FieldByName('SnServico').AsString = 'ATIVO' then
    begin
      ChkSnServico.Checked    := True;
    end
    else
    begin
      ChkSnServico.Checked    := False;
    end;
    if CdsCopula.FieldByName('SnComissao').AsString = 'ATIVO' then
    begin
      ChkSnComissao.Checked   := True;
    end
    else
    begin
      ChkSnComissao.Checked   := False;
    end;
