  ...
  begin
    ...
    begin
      try
        ...
        if CdsPesquisa.FieldByName('SnServico').AsString = 'ATIVO' then
        begin
          FrmTipoPessoa.ChkSnServico.Checked    := True;
        end
        else
        begin
          FrmTipoPessoa.ChkSnServico.Checked    := False;
        end;

        if CdsPesquisa.FieldByName('SnComissao').AsString = 'ATIVO' then
        begin
          FrmTipoPessoa.ChkSnComissao.Checked   := True;
        end
        else
        begin
          FrmTipoPessoa.ChkSnComissao.Checked   := False;
        end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        unTipoPessoa.CarregaDbGrid(DtmPrincipal.Conexao, lSnSituacao, 0, EdtPesquisa.Text, CdsPesquisa);
      end;
    end;
  finally
    unTipoPessoa.Free;
