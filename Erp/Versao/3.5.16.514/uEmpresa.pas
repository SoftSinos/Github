    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Data.FieldByName('NrCelular').AsString                := FormatMaskText('\(99\)99999\-9999;0;_', qryEmpresa.FieldByName('NrCelular').AsString);
...
begin
  ...
  try
    ...
    begin
      ...
      qryEmpresa.SQL.Add('  NrCelular     = :NrCelular,    ');
    ...
    qryEmpresa.ParamByName('NrCelular')     .AsString     := NrCelular;
...
begin
  ...
  try
    ...
    begin
      ...
      NrCelular               := qryEmpresa.FieldByName('NrCelular').AsString;
