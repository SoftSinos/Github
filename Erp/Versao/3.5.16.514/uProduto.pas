...
type
  ...
  public
    ...
    property IdEmpresaEstoque   : Integer read    FIdEmpresaEstoque   write FIdEmpresaEstoque;
    ...
    property IdEmpresaValor     : Integer read    FIdEmpresaValor     write FIdEmpresaValor;
    ...
    procedure CarregaDbGrid(ASQLConnection: TFDConnection; ISnSituacao: Integer; AIdProduto: Integer; AIdEmpresa: Integer; AConsulta: String; Data: TClientDataSet);
...
procedure TProduto.CarregaDbGrid(ASQLConnection: TFDConnection; ISnSituacao: Integer; AIdProduto: Integer; AIdEmpresa: Integer; AConsulta: String; Data: TClientDataSet);
var
  qryProduto : TFDQuery;
  I            : Integer;
  lCampo       : TField;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        qryProduto.SQL.Add('  And IdEmpresaValor = :IdEmpresaValor');

        qryProduto.ParamByName('IdEmpresaValor').AsInteger := AIdEmpresa
      end;
      ...
      begin
        ...
        begin
          ...
          Data.FieldByName('IdEmpresaEstoque').AsInteger  := qryProduto.FieldByName('IdEmpresaEstoque').AsInteger;
          Data.FieldByName('NmRazaoSocial').AsString      := qryProduto.FieldByName('NmRazaoSocial').AsString;
          Data.FieldByName('NmFantasia').AsString         := qryProduto.FieldByName('NmFantasia').AsString;
          Data.FieldByName('QtdEstoque').AsFloat          := qryProduto.FieldByName('QtdEstoque').AsFloat;
          Data.FieldByName('IdProdutoValor').AsInteger    := qryProduto.FieldByName('IdProdutoValor').AsInteger;
          Data.FieldByName('IdEmpresaValor').AsInteger    := qryProduto.FieldByName('IdEmpresaValor').AsInteger;
...
begin
  ...
  try
    ...
    begin
      ...
      IdEmpresaEstoque  := qryProduto.FieldByName('IdEmpresaEstoque').AsInteger;
      NmRazaoSocial     := qryProduto.FieldByName('NmRazaoSocial').AsString;
      NmFantasia        := qryProduto.FieldByName('NmFantasia').AsString;
      QtdEstoque        := qryProduto.FieldByName('QtdEstoque').AsFloat;
      IdProdutoValor    := qryProduto.FieldByName('IdProdutoValor').AsInteger;
      IdEmpresaValor    := qryProduto.FieldByName('IdEmpresaValor').AsInteger;
