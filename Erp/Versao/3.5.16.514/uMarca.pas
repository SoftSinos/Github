...
begin
  ...
  try
    ...
    begin
      ...
      qryMarca.SQL.Add('  *');
      qryMarca.SQL.Add('From VW_GridMarca');
      ...
      if AIdMarca > 0 then
      begin
        qryMarca.SQL.Add('  And IdMarca = :IdMarca');

        qryMarca.ParamByName('IdMarca').AsInteger := AIdMarca
      end;
      ...
      begin
        ...
        begin
          ...
          Data.FieldByName('NmUsuarioCadastro').AsString := qryMarca.FieldByName('NmUsuarioCadastro').AsString;
          Data.Post;
        end;
...
begin
  ...
  try
    qryMarca.Connection := ASQLConnection;
    qryMarca.SQL.Add('Select * From VW_GridMarca');
    qryMarca.SQL.Add('Where IdMarca = :IdMarca');

    qryMarca.ParamByName('IdMarca').AsString := IntToStr(AIdMarca);
    ...
    begin
      ...
      NmUsuarioCadastro := qryMarca.FieldByName('NmUsuarioCadastro').AsString;
    end;
    qryMarca.Close;
  finally
    FreeAndNil(qryMarca)
