...
If Not Exists (Select 
               ...
               From SysColumns 
                 Inner Join SysObjects 
                   On SysColumns.Id = SysObjects.Id
               Where SysColumns.Name='ObsNota'
                 And SysObjects.Name='Nota')
  Begin                   
    Alter Table Nota Add ObsNota NVarchar(4000) Null
  End
Go
...
Begin
	...
	If (Select Count(*) From TipoPessoa) = 0
	  Begin
        Insert Into TipoPessoa([IdUsuario], [NmTpPessoa], [SnCliente]) Values (0, 'CLIENTE', 1) 
        Insert Into TipoPessoa([IdUsuario], [NmTpPessoa], [SnFuncionario]) Values (0, 'PROFISSIONAL', 1) 
        Insert Into TipoPessoa([IdUsuario], [NmTpPessoa], [SnFornecedor]) Values (0, 'FORNECEDOR', 1) 
      End	
...
/* VERSIONAMENTO */
If (Select Count(*) From Versao Where NrVersaoBd = '3.5.16.514') = 0
  Begin
    Insert Into Versao (NrVersaoBd, NrVersaoApp) Values ('3.5.16.514', '3.5.16.514')
  End	
Go