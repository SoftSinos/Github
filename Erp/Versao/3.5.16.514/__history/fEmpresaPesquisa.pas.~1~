...
uses
  ...
  cxLookAndFeelPainters, cxContainer, cxEdit, cxTextEdit, Vcl.Menus, cxButtons;
  ...
  begin
    ...
    begin
      try
        ...
        FrmEmpresa.MkeNrCelular.Text          := CdsPesquisa.FieldByName('NrCelular').AsString;
...
begin
  ...
  try
    ...
    begin
      unEmpresa.CarregaDbGrid(DtmPrincipal.Conexao, 2, DtmPrincipal.IdEmpresaLogada, EdtPesquisa.Text, dnRelatorios.CDSRelPesquisa);
    end
    else
    begin
      unEmpresa.CarregaDbGrid(DtmPrincipal.Conexao, 2, 0, EdtPesquisa.Text, dnRelatorios.CDSRelPesquisa);
    end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if not DtmPrincipal.UsuarioAdministrador then
        begin
          unEmpresa.CarregaDbGrid(DtmPrincipal.Conexao, lSnSituacao, DtmPrincipal.IdEmpresaLogada, EdtPesquisa.Text, CdsPesquisa);
        end
        else
        begin
          unEmpresa.CarregaDbGrid(DtmPrincipal.Conexao, lSnSituacao, 0, EdtPesquisa.Text, CdsPesquisa);
        end;
