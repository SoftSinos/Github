...
begin
  ...
  try
    uProcedure.Agendar(Integer(CbbIdEmpresa.Properties.Items.Objects[CbbIdEmpresa.ItemIndex]), Integer(CbbIdEmpresa.Properties.Items.Objects[CbbIdEmpresa.ItemIndex]), StrToInt(EdtIdRegistro.Text), FormatDateTime('YYYY', Now), 'Profissional');
  finally
...
begin
  ...
  try
    uProcedure.Agendar(0, Integer(CbbIdEmpresa.Properties.Items.Objects[CbbIdEmpresa.ItemIndex]), StrToInt(EdtIdRegistro.Text), '', 'DeletaProfissional');
  finally
