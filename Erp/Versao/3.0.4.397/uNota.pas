...
type
  ...
  public
    ...
    procedure CarregaDbGrid(ASQLConnection: TFDConnection; ISnSituacao: Integer; AIdNota: Integer; AIdEmpresa: Integer; AConsulta: String; Data: TClientDataSet);
  end;
...
procedure TNota.CarregaDbGrid(ASQLConnection: TFDConnection; ISnSituacao: Integer; AIdNota: Integer; AIdEmpresa: Integer; AConsulta: String; Data: TClientDataSet);
var
  qryNota : TFDQuery;
  I            : Integer;
  lCampo       : TField;
...
begin
  ...
  try
    qryNota.Connection := ASQLConnection;
    qryNota.SQL.Add('Select * From Nota');
    qryNota.SQL.Add('Where IdNota = :IdNota');
