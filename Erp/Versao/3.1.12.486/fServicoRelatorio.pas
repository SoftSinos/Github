...
begin
  ...
  begin
    try
      ...
      uProcedure.FastCurvaABCProfissional(Integer(CbbIdEmpresa.Properties.Items.Objects[CbbIdEmpresa.ItemIndex]), DtpDtInicio.Date, DtpDtFinal.Date, 'Servico', 'Periodo', dnRelatorios.CDSRelPesquisa);
...
procedure TFrmServicoRelatorio.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  DtmPrincipal.unLog.NmOperacao := 'Entrou';
  DtmPrincipal.unLog.NmClasse   := 'TFrmServicoRelatorio';
...
procedure TFrmServicoRelatorio.FormCreate(Sender: TObject);
begin
  DtmPrincipal.unLog.NmOperacao := 'Entrou';
  DtmPrincipal.unLog.NmClasse   := 'TFrmServicoRelatorio';
...
procedure TFrmServicoRelatorio.FormShow(Sender: TObject);
begin
  DtmPrincipal.unLog.NmOperacao := 'Entrou';
  DtmPrincipal.unLog.NmClasse   := 'TFrmServicoRelatorio';
