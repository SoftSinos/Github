...
begin
  ...
  try
    ...
    begin
      ...
      Data.FieldDefs.Add('NmFantasiaNmRazaoSocial',    ftString,   255, False);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            Data.FieldByName('NmFantasiaNmRazaoSocial')    .AsString   := qryServico.FieldByName('NmFantasiaNmRazaoSocial')   .AsString;
...
begin
  ...
  try
    ...
    begin
      ...
      NmFantasiaNmRazaoSocial    := qryServico.FieldByName('NmFantasiaNmRazaoSocial')   .AsString;
