...
begin
  ...
  try
    unNotaItem.CarregaDbGrid(DtmPrincipal.Conexao, True, 2, 0, CdsPesquisa.FieldByName('IdEmpresa').AsInteger, CdsPesquisa.FieldByName('IdNota').AsInteger, 'Servico', '', FrmNotaConsumoStarter.CdsServico);
    unNotaItem.CarregaDbGrid(DtmPrincipal.Conexao, True, 2, 0, CdsPesquisa.FieldByName('IdEmpresa').AsInteger, CdsPesquisa.FieldByName('IdNota').AsInteger, 'Produto', '', FrmNotaConsumoStarter.CdsProduto);
  finally
