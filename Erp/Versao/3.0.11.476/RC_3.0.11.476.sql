...
If (Select Count(*) From SysObjects Where Name = 'PC_FastCurvaConsumoCliente' And Type = 'P') > 0
  Begin
    Drop Procedure PC_FastCurvaConsumoCliente 
  End 
Go
...
: M O D I F I C A Ç Õ E S   D E V E   S E R   F E I T A S   P E L O   "D B A"                                :
-------------------------------------------------------------------------------------------------------------*/
Create Procedure [dbo].[PC_FastCurvaConsumoCliente](@IdEmpresaEntrada Integer, @DtInicioEntrada Datetime, @DtFinalEntrada DateTime, @TpChamadaClasse Varchar(255))
As
  /* Informações Uteis
...
If (Select Count(*) From SysObjects Where Name = 'PC_FastCurvaProdutoProfissional' And Type = 'P') > 0
  Begin
    Drop Procedure PC_FastCurvaProdutoProfissional 
  End 
Go
...
: M O D I F I C A Ç Õ E S   D E V E   S E R   F E I T A S   P E L O   "D B A"                                :
-------------------------------------------------------------------------------------------------------------*/
Create Procedure [dbo].[PC_FastCurvaProdutoProfissional](@IdEmpresaEntrada Integer, @DtInicioEntrada Datetime, @DtFinalEntrada DateTime, @TpChamadaClasse Varchar(255))
As
  /* Informações Uteis
...
If (Select Count(*) From SysObjects Where Name = 'PC_FastCurvaServicoProfissional' And Type = 'P') > 0
  Begin
    Drop Procedure PC_FastCurvaServicoProfissional 
  End 
Go
...
: M O D I F I C A Ç Õ E S   D E V E   S E R   F E I T A S   P E L O   "D B A"                                :
-------------------------------------------------------------------------------------------------------------*/
Create Procedure [dbo].[PC_FastCurvaServicoProfissional](@IdEmpresaEntrada Integer, @DtInicioEntrada Datetime, @DtFinalEntrada DateTime, @TpChamadaClasse Varchar(255))
As
  /* Informações Uteis
...
If (Select Count(*) From SysObjects Where Name = 'PC_FastCurvaTipoPagamento' And Type = 'P') > 0
  Begin
    Drop Procedure PC_FastCurvaTipoPagamento 
  End 
Go
...
: M O D I F I C A Ç Õ E S   D E V E   S E R   F E I T A S   P E L O   "D B A"                                :
-------------------------------------------------------------------------------------------------------------*/
Create Procedure [dbo].[PC_FastCurvaTipoPagamento](@IdEmpresaEntrada Integer, @DtInicioEntrada Datetime, @DtFinalEntrada DateTime, @TpChamadaClasse Varchar(255))
As
  /* Informações Uteis
...
If (Select Count(*) From SysObjects Where Name = 'PC_FastComissaoServicoProfissional' And Type = 'P') > 0
  Begin
    Drop Procedure PC_FastComissaoServicoProfissional 
  End 
Go
...
: M O D I F I C A Ç Õ E S   D E V E   S E R   F E I T A S   P E L O   "D B A"                                :
-------------------------------------------------------------------------------------------------------------*/
Create Procedure [dbo].[PC_FastComissaoServicoProfissional](@IdEmpresaEntrada Integer, @DtInicioEntrada Datetime, @DtFinalEntrada DateTime, @TpChamadaClasse Varchar(255))
As
  /* Informações Uteis
