...
uses
  ...
  uAgendaEncaixe in 'uAgendaEncaixe.pas',
  uProdutoEstoque in 'uProdutoEstoque.pas',
  uProdutoValor in 'uProdutoValor.pas',
  fNotaEntradaEstoque in 'fNotaEntradaEstoque.pas' {FrmNotaEntrada};
