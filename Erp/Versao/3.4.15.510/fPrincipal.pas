...
type
  TFrmPrincipal = class(TForm)
    ...
    N13: TMenuItem;
    MenContas: TMenuItem;
    N1LanarDespesas1: TMenuItem;
    N2LanarReceitas1: TMenuItem;
    N31: TMenuItem;
    N3BaixarContas1: TMenuItem;
  ...
  begin
    ...
    begin
      ...
      DtmEmail.GerarEmail('log@softsinos.com.br',
                          ...
                          'Cliente: ' + DtmPrincipal.NmFantasiaNmRazaoSocial + #13 + 'Usuário: ' + DtmPrincipal.NmUsuario + #13 + 'Operação: Autenticação de Usuário' + #13 + 'Dia: ' + DateToStr(Now) + #13 + 'Horário: ' + TimeToStr(Now),
                           False,
                           False);
    end;
  end;
