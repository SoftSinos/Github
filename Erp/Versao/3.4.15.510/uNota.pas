...
type
  ...
  public
    ...
    property SnFinalizada           : Integer   read FSnFinalizada            write FSnFinalizada;
    ...
    class function Finalizar(ASQLConnection: TFDConnection; AIdNota: Integer; AIdEmpresa: Integer): Boolean;
...
begin
  ...
  try
    ...
    begin
      ...
      Data.FieldDefs.Add('SnFinalizada', ftString, 20, False);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if qryNota.FieldByName('SnFinalizada').AsBoolean then
          begin
            Data.FieldByName('SnFinalizada').AsString             := 'CONSUMO ABERTO';
          end else begin
            Data.FieldByName('SnFinalizada').AsString             := 'CONSUMO FINALIZADO';
          end;
          ...
          Data.FieldByName('NrCelular').AsString                := FormatMaskText('\(99\)99999\-9999;0;_', qryNota.FieldByName('NrCelular').AsString);
...
begin
  ...
  try
    ...
    begin
      ...
      qryNota.SQL.Add('Where IdEmpresa = :IdEmpresa ');
      qryNota.SQL.Add('  And IdNota = :IdNota       ');
...
class function TNota.Finalizar(ASQLConnection: TFDConnection; AIdNota, AIdEmpresa: Integer): Boolean;
var
  qryNota: TFDQuery;
begin
  qryNota:= TFDQuery.Create(Nil);
  try
    qryNota.Connection := ASQLConnection;
    qryNota.SQL.Add('Update Nota Set                           ');
    qryNota.SQL.Add('  SnFinalizada = 0                        ');
    qryNota.SQL.Add('Where 1 = 1                               ');
    qryNota.SQL.Add('  And IdNota = ' + IntToStr(AIdNota)       );
    qryNota.SQL.Add('  And IdEmpresa = ' + IntToStr(AIdEmpresa) );
   try
...
begin
  ...
  try
    ...
    begin
      ...
      NrCelular               := qryNota.FieldByName('NrCelular').AsString;
