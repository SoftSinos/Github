  ...
  begin
    ...
    begin
      try
        ...
        begin
          unProduto.CarregaDbGrid(DtmPrincipal.Conexao, lSnSituacao, CdsPesquisa.FieldByName('IdProduto').AsInteger, DtmPrincipal.IdEmpresaLogada, '',  FrmProduto.CdsPesquisa);
        end
        else
        begin
          unProduto.CarregaDbGrid(DtmPrincipal.Conexao, lSnSituacao, CdsPesquisa.FieldByName('IdProduto').AsInteger, 0, '', FrmProduto.CdsPesquisa);
        end;
...
begin
  ...
  try
    ...
    if not DtmPrincipal.UsuarioAdministrador then
    begin
      unProduto.CarregaDbGrid(DtmPrincipal.Conexao, 1, 0, DtmPrincipal.IdEmpresaLogada, '', CdsPesquisa);
    end
    else
    begin
      unProduto.CarregaDbGrid(DtmPrincipal.Conexao, 1, 0, 0, '', CdsPesquisa);
    end;
...
begin
  ...
  begin
    ...
    FrmProduto.GrbEmpresa.Enabled  := True;
  end
  else
  begin
    ...
    FrmProduto.GrbEmpresa.Enabled  := False;
  end;
end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if not DtmPrincipal.UsuarioAdministrador then
        begin
          unProduto.CarregaDbGrid(DtmPrincipal.Conexao, lSnSituacao, 0, DtmPrincipal.IdEmpresaLogada, '', CdsPesquisa);
        end
        else
        begin
          unProduto.CarregaDbGrid(DtmPrincipal.Conexao, lSnSituacao, 0, 0, '', CdsPesquisa);
        end;
