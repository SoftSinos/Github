...
procedure TFrmTipoServico.BtnCancelarClick(Sender: TObject);
begin
  inherited;

  BtnMostrarCor.Colors.Disabled     :=  clWhite;
  BtnMostrarCor.Colors.DisabledText :=  clWhite;

end;

procedure TFrmTipoServico.BtnCoresClick(Sender: TObject);
begin
  DtmPrincipal.unLog.NmOperacao := 'Entrou';
  DtmPrincipal.unLog.NmClasse   := 'TFrmTipoServico';
  DtmPrincipal.unLog.NmMetodo   := 'BtnCoresClick';
  DtmPrincipal.unLog.NmTabela   := 'TipoServico';
  DtmPrincipal.unLog.GerarLog(DtmPrincipal.Conexao);

  inherited;
  try
    if ClrDialog.Execute then
    begin
      BtnMostrarCor.Colors.Disabled     := ClrDialog.Color;
      BtnMostrarCor.Colors.DisabledText := ClrDialog.Color;
...
begin
  ...
  try
    ...
    begin
      ...
      unTipoServico.HxCor          := ColorToString(BtnMostrarCor.Colors.Disabled);
...
begin
  ...
  try
    ...
    DtpHrServico.Time         := CdsCopula.FieldByName('HrServico').AsDateTime;
  finally
