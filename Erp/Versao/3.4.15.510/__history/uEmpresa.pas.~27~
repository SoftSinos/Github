...
begin
  ...
  try
    ...
    begin
      ...
      Data.FieldDefs.Add('NmRazaoSocialNmFantasia', ftString, 120, False);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Data.FieldByName('NmRazaoSocialNmFantasia').AsString  := qryEmpresa.FieldByName('NmRazaoSocialNmFantasia').AsString;
...
begin
  ...
  try
    ...
    begin
      ...
      NmRazaoSocialNmFantasia := qryEmpresa.FieldByName('NmRazaoSocialNmFantasia').AsString;
