...
begin
  ...
  try
    ...
    begin
      unPessoa.CarregaDbGrid(DtmPrincipal.Conexao, 2, DtmPrincipal.IdEmpresaLogada, 0, EdtPesquisa.Text, 0, '', dnRelatorios.CDSRelPesquisa);
    end;

    FrmProcessando.Destroy;

    dnRelatorios.frxPDFExport.ShowDialog := True;
    dnRelatorios.frxReport.LoadFromFile(DtmPrincipal.NmCaminhoExecutavel +  'Relatorio\RelPesqImpPessoa.fr3');
...
begin
  ...
  //Quando diferente de carregado ele só carrega os dados na tela que foi chamada.
  ...
  try
    ...
    begin
      ...
      begin
        ...
        unPessoa.CarregaDbGrid(DtmPrincipal.Conexao, 2, 0, 0, EdtPesquisa.Text, 0, '', CdsPesquisa);
      end;
    end;
  finally
    unPessoa.Free;
