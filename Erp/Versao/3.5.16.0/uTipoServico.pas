    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Data.FieldByName('HxCor').AsString              := qryTipoServico.FieldByName('HxCor').AsString;
...
begin
  ...
  try
    ...
    begin
      ...
      qryTipoServico.SQL.Add('  HxCor           =    :HxCor,          ');
    ...
    qryTipoServico.ParamByName('HxCor'          ).AsString    := HxCor;
...
begin
  ...
  try
    ...
    begin
      ...
      HxCor             := qryTipoServico.FieldByName('HxCor'             ).AsString;
