...
type
  ...
  public
    ...
    function BuscarEstoque(ASQLConnection: TFDConnection; AIdProduto: Integer; AIdEmpresa: Integer): Boolean;
...
function TProdutoEstoque.BuscarEstoque(ASQLConnection: TFDConnection; AIdProduto, AIdEmpresa: Integer): Boolean;
var
  qryProdutoEstoque: TFDQuery;
begin
  Result := False;
  ...
  try
    ...
    begin
      qryProdutoEstoque.SQL.Add('  And IdProduto = ' + IntToStr(AIdProduto));
    end;

    if AIdEmpresa > 0 then
    begin
      qryProdutoEstoque.SQL.Add('  And IdEmpresa = ' + IntToStr(AIdEmpresa));
    end;
