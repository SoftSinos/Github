...
type
  TFrmProduto = class(TFrmCadastro)
    ...
    procedure EdtNrEanEditing(Sender: TObject; var CanEdit: Boolean);
...
procedure TFrmProduto.CarregarTela;
begin
  DtmPrincipal.unLog.NmOperacao := 'Entrou';
  DtmPrincipal.unLog.NmClasse   := 'TFrmProduto';
...
procedure TFrmProduto.EdtNrEanEditing(Sender: TObject; var CanEdit: Boolean);
begin
  inherited;
  MsgInformacao('Editou')
end;
