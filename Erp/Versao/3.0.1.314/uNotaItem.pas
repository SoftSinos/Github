...
type
  ...
  public
    ...
    property QtdNotaItem: Integer read FQtdNotaItem write FQtdNotaItem;
    ...
    procedure CarregaDbGrid(ASQLConnection: TFDConnection; SnQuery: Boolean; ISnSituacao: Integer; AIdNotaItem: Integer; AIdEmpresa: Integer; AIdNota: Integer; AConsulta: String; Data: TClientDataSet);
  end;
...
procedure TNotaItem.CarregaDbGrid(ASQLConnection: TFDConnection; SnQuery: Boolean; ISnSituacao: Integer; AIdNotaItem: Integer;  AIdEmpresa: Integer; AIdNota: Integer; AConsulta: String; Data: TClientDataSet);
var
...
begin
  ...
  try
    ...
    begin
      ...
      Data.FieldDefs.Add('QtdNotaItem', ftInteger);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            Data.FieldByName('QtdNotaItem').AsInteger := qryNotaItem.FieldByName('QtdNotaItem').AsInteger;
...
begin
  ...
  try
    ...
    qryNotaItem.ParamByName('QtdNotaItem').AsInteger := QtdNotaItem;
...
begin
  ...
  try
    ...
    begin
      ...
      QtdNotaItem := qryNotaItem.FieldByName('QtdNotaItem').AsInteger;
