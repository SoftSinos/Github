...
type
  ...
  public
    ...
    procedure CarregaDbGridHorarios(ASQLConnection: TFDConnection; AIdEmpresa: Integer; Data: TClientDataSet);
...
procedure TAgenda.CarregaDbGridHorarios(ASQLConnection: TFDConnection; AIdEmpresa: Integer; Data: TClientDataSet);
var
  qryAgenda : TFDQuery;
  I         : Integer;
  lCampo    : TField;
