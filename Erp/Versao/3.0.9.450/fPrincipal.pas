...
uses
  ...
  cxLookAndFeelPainters, cxButtons, Vcl.ButtonGroup, JvExComCtrls, JvToolBar, Vcl.Themes, ClipBrd;
...
type
  TFrmPrincipal = class(TForm)
    ...
    RelCurvaMelhoresClientes      : TMenuItem;
    RelCurvaMelhoresProfissionais : TMenuItem;
    RelCurvaMelhoresServicos      : TMenuItem;
    RelCurvaMelhoresProdutos      : TMenuItem;
    RelFechamentoCaixa            : TMenuItem;
    RelFaturamentoPeriodo         : TMenuItem;
    RelComissaoProfissional       : TMenuItem;
...
uses dRelatorios, uMensagem, uEmpresa, uProcedure, fCopiaSeguranca, fEmpresa, fLogin, fSplash, fSobre, fInformacoes, fProcessando, fConfiguracaoPesquisa, fLogPesquisa,
  ...
  fGrupoServicoPesquisa, fExecutaScriptSQL, fAbrirAgendaGeral, fPainelDiario;
