...
uses uFuncao, dPrincipal, fPrincipal, uConfiguracao, uPessoa, uAgenda, fProcessando, fAgendaStarter, uMensagem, fAjuda, fDataPeriodo;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          StgGrid.Cells[lNrCol, I] := (CdsAgenda.FieldByName('StAgenda').AsString);
        end;
        CdsAgenda.Next;
      end;
    end;
...
begin
  ...
  //AGENDA - NÚMERO TOTAL DE ATENDIMENTOS
