      ...
      begin
        ...
        begin
          ...
          begin
            ...
            FrmPrincipal.StbPrincipal.Panels[3].Text    := 'Usuário: ' + EdtNmUsuario.Text;
          ...
          begin
            ...
            begin
              ...
              FrmPrincipal.StbPrincipal.Panels[3].Text  := 'Usuário: ' + DtmPrincipal.NmUsuario;
              FrmPrincipal.StbPrincipal.Panels[4].Text  := 'Empresa: ' + DtmPrincipal.NmFantasiaNmRazaoSocial;
      ...
      try
        ...
        begin
          DtmEmail.GerarEmail('log@softsinos.com.br',
                              ...
                              'Cliente: ' + DtmPrincipal.NmFantasiaNmRazaoSocial + #13 + 'Usuário: ' + EdtNmUsuario.Text + #13 + 'Operação: Autenticação de Usuário' + #13 + 'Dia: ' + DateToStr(Now) + #13 + 'Horário: ' + TimeToStr(Now),
                              False,
                              False);
        end
