...
begin
  ...
  if not DirectoryExists(DtmPrincipal.NmCaminhoExecutavel + 'Seguranca\Terça-Feira') then
  begin
    CreateDir(DtmPrincipal.NmCaminhoExecutavel + 'Seguranca\Terça-Feira')
  end;
  ...
  if not DirectoryExists(DtmPrincipal.NmCaminhoExecutavel + 'Seguranca\Sábado') then
  begin
    CreateDir(DtmPrincipal.NmCaminhoExecutavel + 'Seguranca\Sábado')
  end;
