...
type
  ...
  // CallBack Function
  NBioAPI_WINDOW_CALLBACK = Function(pCallbackParam, pUserParam: Pointer)
    : DWORD; stdcall;
  ...
  NBioAPI_WINDOW_OPTION_2 = record
    ...
    DisableFingerForEnroll: array [0 .. 9] of BYTE;
  ...
  NBioAPI_FINGER_DATA_2 = record
    Length: DWORD; // sizeof of structure
    FingerID: BYTE; // NBioAPI_FINGER_ID
    Template: NBioAPI_TEMPLATE_DATA_PTR_2;
    // Template = NBioAPI_TEMPLATE_DATA_2 * SamplesPerFinger
  end;
  ...
  NBioAPI_EXPORT_DATA = record
    ...
    FingerData: NBioAPI_FINGER_DATA_PTR;
    // only used for MINCONV_TYPE_FDP ~ MINCONV_TYPE_OLD_FDA
    FingerData2: NBioAPI_FINGER_DATA_PTR_2; // used for all type
  end;

  // Get NBioAPI_VERSION
  TFNBioAPI_GetVersion = Function(hHandle: DWORD; pVersion: NBioAPI_VERSION_PTR)
    : DWORD; stdcall;
  // Get NBioAPI_Infomation
  TFNBioAPI_GetInitInfo = Function(hHandle: DWORD; nStructureType: BYTE;
    pInitInfo: NBioAPI_INIT_INFO_PTR_0): DWORD; stdcall;
  // Set NBioAPI_Information
  TFNBioAPI_SetInitInfo = Function(hHandle: DWORD; nStructureType: BYTE;
    pInitInfo: NBioAPI_INIT_INFO_PTR_0): DWORD; stdcall;
  // Open Device
  TFNBioAPI_OpenDevice = Function(hHandle: DWORD; nDeviceID: WORD)
    : DWORD; stdcall;
  // Close Device
  TFNBioAPI_CloseDevice = Function(hHandle: DWORD; nDeviceID: WORD)
    : DWORD; stdcall;
  ...
  TFNBioAPI_EnumerateDevice = Function(hHandle: DWORD; pNumDevice: Pointer;
    ppDeviceID: Pointer): DWORD; stdcall;

  TFNBioAPI_Enroll = Function(hHandle: DWORD;
    const piStoredTemplate: NBioAPI_INPUT_FIR_PTR; phNewTemplate: Pointer;
    const pPayload: NBioAPI_FIR_PAYLOAD_PTR; nTimeout: Integer;
    phAuditData: Pointer; const pWindowOption: NBioAPI_WINDOW_OPTION_PTR)
    : DWORD; stdcall;

  TFNBioAPI_Verify = Function(hHandle: DWORD;
    const piStoredTemplate: NBioAPI_INPUT_FIR_PTR; pbResult: Pointer; // Bool*;
    pPayload: NBioAPI_FIR_PAYLOAD_PTR; nTimeout: Integer; phAuditData: Pointer;
    // DWORD*
    const pWindowOption: NBioAPI_WINDOW_OPTION_PTR): DWORD; stdcall;

  TFNBioAPI_GetFIRFromHandle = Function(hHandle: DWORD; hFIR: DWORD;
    pFIR: NBioAPI_FIR_PTR): DWORD; stdcall;

  TFNBioAPI_GetHeaderFromHandle = Function(hHandle, hFIR: DWORD;
    pHeader: NBioAPI_FIR_HEADER_PTR): DWORD; stdcall;

  TFNBioAPI_FreeTextFIR = Function(hHandle: DWORD;
    pTextFIR: NBioAPI_FIR_TEXTENCODE_PTR): DWORD; stdcall;

  TFNBioAPI_GetTextFIRFromHandle = Function(hHandle, hFIR: DWORD;
    pTextFIR: NBioAPI_FIR_TEXTENCODE_PTR; bIsWide: BOOL): DWORD; stdcall;
  ...
  TFNBioAPI_FreePayload = Function(hHandle: DWORD;
    pPayload: NBioAPI_FIR_PAYLOAD_PTR): BOOL; stdcall;

  TFNBioAPI_Capture = Function(hHandle: DWORD; nPurpose: NBioAPI_FIR_PURPOSE;
    phCapturedFIR: Pointer; // NBioAPI_FIR_HANDLE_PTR;
    nTimeout: Integer; phAuditData: Pointer; // NBioAPI_FIR_HANDLE_PTR;
    const pWindowOption: NBioAPI_WINDOW_OPTION_PTR): DWORD; stdcall;
