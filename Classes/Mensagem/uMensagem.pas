...
function DesejaCancelarOLancamento: String;
begin
  Result := 'DESEJA CANCELAR O LANÇAMENTO?';
end;
...
function DesejaSairDaTelaSemSalvarOsDados: String;
begin
  Result := 'AO FECHAR SAIR DA TELA VOCÊ PERDERÁ OS DADOS!!!';
end;
...
function EntrarEmContatoComOSuporte: String;
begin
  Result := 'ENTRAR EM CONTATO COM A EQUIPE DE SUPORTE' + #13 + #13 + 'SoftSinos Informática' + #13 +'Telefone: (51)-98501-1901' + #13 + 'e-mail: suporte@softsinos.com.br';
end;
...
function CampoChaveDaTabelaNaoSeraModificado: String;
begin
  Result := 'CAMPO CHAVE DA TABELA. O MESMO NÃO SERÁ MODIFICADO!';
end;

function DesejaRealizarCopiaSeguranca: String;
begin
  Result := 'DESEJA REALIZAR UMA CÓPIA DE SEGURANÇA?';
end;
...
function ProdutoInexistenteNoEstoque: String;
begin
  Result := 'PRODUTO INEXISTÊNTE NO ESTOQUE!';
end;
...
function ParaModificarOsLancamentosVoceDeveLimparOsLancamentosAnteriores: String;
begin
  Result := 'PARA MODIFICAR OS LANÇAMENTOS, VOCÊ DEVE LIMPAR OS LANÇAMENTOS ANTERIORES!';
end;

function ExclusaoPrivilegios: String;
begin
  Result := 'EXCLUSÃO DE PRIVILÉGIOS!';
end;
...
function JaEstamosNoPrimeiroRegistro: String;
begin
  Result := 'JÁ ESTAMOS NO PRIMEIRO REGISTRO!';
end;

function JaEstamosNoUltimoRegistro: String;
begin
  Result := 'JÁ ESTAMOS NO ÚLTIMO REGISTRO!';
end;
...
function CopiaSegurancaRealizadaComSucesso: String;
begin
  Result := 'CÓPIA DE SEGURANÇA REALIZADA COM SUCESSO!';
end;
...
function ArquivoDeConexaoNaoEncontrado: String;
begin
  Result := 'ARQUIVO DE CONEXÃO NÃO ENCONTRADO!';
end;

function ASenhaNaoConfere: String;
begin
  Result := 'A SENHA INFORMADA NÃO CONFERE!';
end;
...
function DispositivoNaoDetectado: String;
begin
  Result := 'DISPOSITIVO NÃO CONECTADO AO SEU COMPUTADOR!';
end;
...
function DesejaRodarProcedureDeInicializacao: String;
begin
  Result := 'DESEJA RODAR A PROCEDURE DE INICIALIZAÇÃO DE DADOS?';
end;

function ErroNaInicializacaoDoDispositivo: String;
begin
  Result := 'ERRO NA INICIALIZAÇÃO DO DISPOSITIVO!';
end;
...
function ErroAoTentarSalvarORegisto: String;
begin
  Result := 'ERRO AO TENTAR SALVAR O REGISTRO!' + #13 + 'REALIZE UMA PESQUISA, O CADASTRO JA DEVE EXISTIR!' + #13 + 'CONSULTE TAMBÉM O LOG DO SISTEMA.';
end;
...
function FalhaNaExtracaoDaBiometria: String;
begin
  Result := 'FALHA NA EXTRAÇÃO DA BIOMÉTRIA!';
end;

function FalhaNaCapturaDaBiometria: String;
begin
  Result := 'FALHA NA CAPTURA DA BIOMÉTRIA!';
end;

function ImportacaoDoDadosRealizadaComSucesso: String;
begin
  Result := 'IMPORTAÇÃO DOS DADOS REALIZADA COM SUCESSO!';
end;
...
function NaoExistemDadosParaSeremAlterados: String;
begin
  Result := 'NÃO EXISTEM DADOS PARA SEREM ALTERADOS!';
end;

function NaoExisteCadastroDeEmpresa: String;
begin
  Result := 'NÃO EXISTE NENHUM CADASTRO DE EMPRESA!' + #13 + 'DESEJA REALIZAR O CADASTRO AGORA?';
end;
...
function ORegistroNaoPodeSerAlteradoPoisEChava: String;
begin
  Result := 'O REGISTRO NÃO PODE SER ALTERADO POIS É CHAVE DE OUTROS PROCESSOS!';
end;
...
function OCepNaoFoiEntrado: String;
begin
  Result := 'O CEP NÃO FOI ENCONTRADO!';
end;

function OCPFJaExiste: String;
begin
  Result := 'O CPF JÁ EXISTE!';
end;

function OCPFInformadoEInvalido: String;
begin
  Result := 'O CPF INFORMADO É INVALIDO!';
end;

function OCNPJInformadoEInvalido: String;
begin
  Result := 'O CNPJ INFORMADO É INVALIDO!';
end;

function OSistemaSeraFinalizado: String;
begin
  Result := 'O SISTEMA SERÁ FINALIZADO.' + #13 + 'VOCÊ DEVERÁ ABRIR O SISTEMA NOVAMENTE!';
end;

function OArquivoNaoExisteOuNaoLocalizado: String;
begin
  Result := 'O ARQUIVO NÃO EXISTE OU NÃO PODE SER LOCALIZADO!';
end;
...
function OValorDoParametroNaoENumero: String;
begin
  Result := 'O VALOR DO PARAMETRO NÃO É NÚMERICO!';
end;

function OValorDoParametroNaoELetra: String;
begin
  Result := 'O VALOR DO PARAMETRO NÃO É LETRA!';
end;

function ParaAlterarUmaMarcacaoASituacaoDaMesmaDeveSerAtiva: String;
begin
  Result := 'PARA ALTERAR UMA MARCAÇÃO A SITUAÇÃO DA MESMA DEVE SER ATIVA!';
end;

function ParametroNaoConfigurado: String;
begin
  Result := 'PARAMETRO NÃO CONFIGURADO!';
end;
...
function SuaConexaoTimeOutE: String;
begin
  Result := 'SUA CONEXÃO TIME OUT É DE ';
end;
...
function TipoDeFiltroDeConsultaInvalido: String;
begin
  Result := 'TIPO DO FILTRO DA CONSULTA É INVALIDO!';
end;
...
function UsuarioNaoCadastrado: String;
begin
  Result := 'USUÁRIO NÃO CADASTRO OU NÃO ENCONTRADO!';
end;
...
function VerificarOsCamposQueContemOSinalDeAsterisco: String;
begin
  Result := 'VERIFICAR OS CAMPO QUE CONTÉM O SINAL DE (*) ASTERISCO!';
end;
